...
const analysisOfRequirements = `fond out what you need to complete project`
const design = `stage where you create the layout for the project`
const implementation = `build a working project`
const testingAndIntegration = `test and debug the project and then have the project live and in use`
const maintain = `make sure project is running with no issues and fix and make changes and updates`